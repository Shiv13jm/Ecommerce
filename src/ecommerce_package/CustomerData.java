...
public class CustomerData {
    ...
    // Checkout → calls OrderData module
    public boolean checkout(int userId, Map<Integer, Integer> cartItems) {
        OrderData orderService = new OrderData();
        String orderId = orderService.placeOrder(userId, cartItems); // this now inserts with valid ENUM
        return orderId != null;
    }
