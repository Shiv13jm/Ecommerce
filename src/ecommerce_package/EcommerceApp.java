...
//
//        // View products
//        viewProductsBtn.addActionListener(e -> viewProductsBtnAction());
//
//        // Admin login
...
//            panel.add(new JLabel("Admin Password:")); panel.add(passField);customerMenu(user);
//
...
//       Map<Integer, Integer> cart = new HashMap<>(); // cart for this session
//       String[] options = {"View Products", "Add to Cart", "View Cart", "Checkout & Pay", "Track Orders", "Logout"};
////
////        while (true) {
...
////
////            if (choice == 0) { 
////                viewProductsBtnAction();
////            } else if (choice == 1) { 
////                CartManager(cart);
////            } else if (choice == 2) { 
////                viewCartAction(cart);
////            } else if (choice == 3) { 
////                checkoutAndPayAction(user, cart);
////            } else if (choice == 4) { 
////                trackOrdersAction(user);
////            } else { 
////                break; // Logout
////            }
////        }
...
//        String[] options = {"View Products", "Add to Cart", "View Cart", "Checkout & Pay", "Logout"};
//
//        while (true) {
//            int choice = JOptionPane.showOptionDialog(this,
//                    "Customer Menu - " + user.getUsername(),
...
//            else if (choice == 3) checkoutAndPayAction(user, cart);
//            else break; // Logout
//        }
//    }
//
...
//            return;
//        }
//        // For simplicity, just clear cart
//        cart.clear();
